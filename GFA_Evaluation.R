...
writeChangetoFile <- function(DailyAnalyses) {
    for (Object in DailyAnalyses) {
        ...
        writeComment(xlsx,"summary",col = "O",row = 1,comment = createComment(comment = str_c("Change is relative to ",Object$PreviousDay,"`n`n Comment generated by GFA_Evaluation.R"),visible = F,eauthor = str_c("GFA_Evaluation.R")))
        writeComment(xlsx,"summary",col = "P",row = 1,comment = createComment(comment = str_c("Change is relative to ",Object$PreviousDay,"`n`n Comment generated by GFA_Evaluation.R"),visible = F,eauthor = str_c("GFA_Evaluation.R")))
...
csv2xlsx <- function(path) {
    ...
    xlsx <- openxlsx::loadWorkbook(path)
