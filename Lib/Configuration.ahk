...
setupdefaultconfig(Switch) {
    ...
    gfcGUIconfig=
        (LTRIM
            ...
            %A_Tab%Normalise:Checkbox|Type:boolean|Default:1|String:"Do you want to normalise your leaf area?"|TTIP:This accesses the data-column 'plant_area_normalised'. For more info, check the documentation.|Tab3Parent:2. GeneralConfiguration|Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:Experiment
            %A_Tab%language:DDL|Type:String|Default:"English"|String:"Select language for auto-generated labels"|ctrlOptions:English,German|Tab3Parent:2. GeneralConfiguration|Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:General
            ...
            %A_Tab%Debug:Checkbox|Type:boolean|Default:0|String:"Do you want to print debug information?"|Tab3Parent:2. GeneralConfiguration|Link:Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:General
            %A_Tab%;;; figure
            %A_Tab%;;
            %A_Tab%;;
            ...
            %A_Tab%ForceAxes:Checkbox|Type:boolean|Default:0|String:"Do you want to force the Y-Axis scaling? This requires setting 'YLimits'"|Tab3Parent:4. Axes|Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:Experiment
            %A_Tab%YLimits:Edit|Type:String|Default:"0,150"|String:"Set the minimum and maximum limit for the Y-Axis. Does not take effect if 'ForceAxes' is false. Used for all plots"|Tab3Parent:4. Axes|Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:Experiment
            %A_Tab%BreakStepSize:Edit|Type:number|Default:25|String:Set the spacing between numbered breaks on the Y-Axis. Requires ForceAxes=T"|ctrlOptions: gcheckDecimalsOnEdit|Tab3Parent:4. Axes|Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:Experiment
            %A_Tab%axis_units_x:Edit|Type:String|Default:Tage,days|String:"Set the unit of the X-axis (for the Overview-plot)."|TTIP:Format: '[German Text],[English Text]'. Replace a field with "/" to skip it|Tab3Parent:4. Axes|Link:https://{GH-Repo}#{Parameter}|Linktext:?|ConfigSection:General
